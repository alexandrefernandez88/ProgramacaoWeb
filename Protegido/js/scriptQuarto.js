const endpoint = 'http://localhost:3010/quartos';
let mensagem = document.getElementById('msg');
let mensagemModal = document.getElementById('msgModal');
let formulario = document.getElementById('frmQuarto');

window.onload = carregarPagina;
formulario.onsubmit = salvarQuarto;
document.getElementById('btnAtualizar').onclick = atualizarQuarto;
...
function getQuarto(){
    const idquarto = document.getElementById('Numero').value;
    const idtipoquarto = document.getElementById('TipoQuarto').value;
